...
def main():
    ...
    df.to_json("../data/raw/solar_panels_conservatives.jsonl", orient='records', lines=True)
    df.drop(columns=['focus_group_all']).to_csv("../data/raw/solar_panels_conservatives.csv", index=False)
